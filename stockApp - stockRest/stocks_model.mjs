...
// Confirm database opens successfullyk
db.once("open", () => {
...
const findStockBYName = async (title) => {
    const query = Stock.findOne({title: title});
    return query.exec();
}
...
export {createStock, findStock, deleteById, findStockByID, replaceStock, findStockBYName};