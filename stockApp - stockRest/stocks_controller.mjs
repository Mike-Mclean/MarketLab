...
/**
 * Create a new stock with the title, year and symbol provided in the body
 */
...
app.get('/stocks/:title', (req, res) => {
    const stockTitle = req.params.title;
    stocks.findStockBYName(stockTitle)
    .then(stock => {
        if (stock !== null){
            res.json(stock);
        } else {
...
/**
 * Delete the stock whose id is provided in the query parameters
 */
